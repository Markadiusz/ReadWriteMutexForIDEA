...
private val VERBOSE = @Suppress("INVISIBLE_REFERENCE", "INVISIBLE_MEMBER") systemProp("test.verbose", false)
...
public open class TestBase(private var disableOutCheck: Boolean)  {
    ...
    fun initPoolsBeforeTest() {
        @Suppress("INVISIBLE_REFERENCE", "INVISIBLE_MEMBER") DefaultScheduler.usePrivateScheduler()
    }

    fun shutdownPoolsAfterTest() {
        @Suppress("INVISIBLE_REFERENCE", "INVISIBLE_MEMBER") DefaultScheduler.shutdown(SHUTDOWN_TIMEOUT)
        @Suppress("INVISIBLE_REFERENCE", "INVISIBLE_MEMBER") DefaultExecutor.shutdownForTests(SHUTDOWN_TIMEOUT)
        @Suppress("INVISIBLE_REFERENCE", "INVISIBLE_MEMBER") DefaultScheduler.restore()
    }
 ...
 */
public val isJavaAndWindows: Boolean = System.getProperty("os.name")!!.contains("Windows")